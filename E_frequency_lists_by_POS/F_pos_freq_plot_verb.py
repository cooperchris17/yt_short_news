'''
This script creates a graph of the 81-100 ranked frequent verbs in the B1_plus dataframe
The graph shows normalised frequency (per million) and the percentage of documents the word is in 
I ran the script 5 times (amending the specified parts) to create graphs for the most frequent 100 verbs
'''
...
top_color = 'saddlebrown'
bottom_color = 'tab:gray'

pos = 'verb'
# change the numbers on the title each time
title = 'B1+ Frequent News Verbs (81-100)'

# delete 2 zeros from the end of the highest frequency (per million) to get 100% on doc_freq axis
# e.g. if the highest frequency (per million) is 600, the scale_factor should be 6
scale_factor = 6
...
# adj colors = royalblue & midnightblue
#
